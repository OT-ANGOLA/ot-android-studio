...
DROP TABLE IF EXISTS ADJACENCY_TYPE;
DROP TABLE IF EXISTS LAND_PROJECT;
...
MERGE INTO CONFIGURATION(CONFIGURATION_ID, NAME, VALUE) KEY (CONFIGURATION_ID) SELECT '1', 'DBVERSION', '1.6.0' FROM DUAL;
...
MERGE INTO LINK(LINK_ID, URL, DESC) KEY (LINK_ID) SELECT '1', 'https://sagit:8080', 'Go to the SAGIT Web site.' FROM DUAL;
...
CREATE UNIQUE INDEX COUNTRY_IDX ON COUNTRY(CODE);

 CREATE TABLE PROVINCE
(ID INT auto_increment PRIMARY KEY,
 CODE VARCHAR(255) NOT NULL,
 DISPLAY_VALUE VARCHAR(512) NOT NULL,
 COUNTRY_CODE VARCHAR(512) NOT NULL,
 ACTIVE BOOLEAN NOT NULL,
 DESCRIPTION VARCHAR(2048));

CREATE UNIQUE INDEX PROVINCE_IDX ON PROVINCE(CODE);
...
CREATE UNIQUE INDEX MUNICIPALITY_IDX ON MUNICIPALITY(CODE);

 CREATE TABLE COMMUNE
(ID INT auto_increment PRIMARY KEY,
 CODE VARCHAR(255) NOT NULL,
 DISPLAY_VALUE VARCHAR(512) NOT NULL,
 MUNICIPALITY_CODE VARCHAR(512) NOT NULL,
 ACTIVE BOOLEAN NOT NULL,
 DESCRIPTION VARCHAR(2048));

CREATE UNIQUE INDEX COMMUNE_IDX ON COMMUNE(CODE);
...
CREATE UNIQUE INDEX LAND_PROJECT_IDX ON LAND_PROJECT(CODE);
...
CREATE UNIQUE INDEX MARITAL_STATUS_IDX ON MARITAL_STATUS(CODE);
...
CREATE UNIQUE INDEX ADJACENCY_TYPE_IDX ON ADJACENCY_TYPE(CODE);
...
ID_EXPIRY_DATE DATE,
ID_ISSUANCE_COUNTRY_CODE VARCHAR(255),
ID_ISSUANCE_PROVINCE_CODE VARCHAR(255),
ID_ISSUANCE_MUNICIPALITY_CODE VARCHAR(255),
ID_ISSUANCE_COMMUNE_CODE VARCHAR(255),
BIRTH_COUNTRY_CODE VARCHAR(255),
BIRTH_PROVINCE_CODE VARCHAR(255),
BIRTH_MUNICIPALITY_CODE VARCHAR(255),
BIRTH_COMMUNE_CODE VARCHAR(255),
RESIDENCE_COUNTRY_CODE VARCHAR(255),
RESIDENCE_PROVINCE_CODE VARCHAR(255),
RESIDENCE_MUNICIPALITY_CODE VARCHAR(255),
RESIDENCE_COMMUNE_CODE VARCHAR(255),
...
NORTH_ADJACENCY_TYPE_CODE VARCHAR(255),
SOUTH_ADJACENCY VARCHAR(255),
SOUTH_ADJACENCY_TYPE_CODE VARCHAR(255),
WEST_ADJACENCY VARCHAR(255),
WEST_ADJACENCY_TYPE_CODE VARCHAR(255),
EAST_ADJACENCY VARCHAR(255),
EAST_ADJACENCY_TYPE_CODE VARCHAR(255),
CLAIM_ID VARCHAR(255) NOT NULL,
FOREIGN KEY (CLAIM_ID)
REFERENCES CLAIM(CLAIM_ID));
