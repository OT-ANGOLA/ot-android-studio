...
REFERENCES MARITAL_STATUS(CODE),
...
FOREIGN KEY (LAND_PROJECT_CODE)
REFERENCES LAND_PROJECT(CODE),
...
ADJACENCY_TYPE_CODE VARCHAR(255),
FOREIGN KEY (ADJACENCY_TYPE_CODE)
REFERENCES ADJACENCY_TYPE(CODE),
